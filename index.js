...
const ownerNumber = ['923448149931']
...
conn.sendMessage(ownerNumber + "@s.whatsapp.net", { image: { url: `https://files.catbox.moe/hzagwo.jpg` }, caption: up })
...
if(senderNumber.includes("923448149931")){
if(isReact) return
m.react("👨‍💻")
}
